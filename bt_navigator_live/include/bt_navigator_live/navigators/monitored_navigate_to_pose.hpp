...
#ifndef BT_NAVIGATOR_LIVE__NAVIGATORS__MONITORED_NAVIGATE_TO_POSE_HPP_
#define BT_NAVIGATOR_LIVE__NAVIGATORS__MONITORED_NAVIGATE_TO_POSE_HPP_
...
/**
 * @class MonitoredNavigateToPoseNavigator
 * @brief Extended NavigateToPose navigator with live Groot monitoring support
 */
class MonitoredNavigateToPoseNavigator 
...
public:
   ...
   * @brief Constructor
   */
  MonitoredNavigateToPoseNavigator()
...
#endif  // BT_NAVIGATOR_LIVE__NAVIGATORS__MONITORED_NAVIGATE_TO_POSE_HPP_
